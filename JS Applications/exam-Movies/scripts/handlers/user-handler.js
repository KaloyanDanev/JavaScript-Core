...
handlers.registerUser = function (ctx) {
  ...
  if (username.length < 3) {
    return notifications.showError('Username must be more than two characters long')
  } else if (password.length < 6) {
    return notifications.showError('Password must be more than five characters long')
  }
